...
import '../models/transfer_sygs_model/input_transfer_sygs_model.dart';
...
abstract class TransferRepository {
  ...
  Future<Result<ResponseModel, FailureModel>> transferSYGS(
      {required InputTransferSygsModel input});

  //-------------
  Future<Result<ResponseModel<List<StaticModel>>, FailureModel>> getBanks();

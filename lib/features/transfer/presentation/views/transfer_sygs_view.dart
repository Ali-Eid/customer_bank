                                      ...
                                      child: Column(
                                        children: [
                                          DropDownAccountWidget(
                                            items:
                                                inputTransferCubit.fromAccounts,
                                          ...
                                          BlocBuilder(
                                            bloc: transferSygsBloc,
                                            builder: (context,
                                                TransferSygsState state) {
                                              return GenericDropdownField<
                                                      StaticModel>(
                                                  hintText: "Select a bank",
                                                  validator: (value) {
                                                    if (inputTransferCubit
                                                            .bank ==
                                                        null) {
                                              ...
                                              return ElevatedButton(
                                                onPressed: () {
                                                  if (_formKey.currentState!
                                                      .validate()) {
                                                    transferSygsBloc.add(TransferSygsEvent
                                                        .transferSYGS(
                                                            input:
                                                                InputTransferSygsModel(
                                                                    bankId: inputTransferCubit
                                                                            .bank
                                                                            ?.id ??
                                                                        0,
                                                                    fromAccount:
                                                                        inputTransferCubit.fromAccount?.accountNumber ??
                                                                            "",
                                                                    toAccount:
                                                                        inputTransferCubit
                                                                            .toAccountNoController
